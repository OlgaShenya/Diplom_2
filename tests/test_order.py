...
from api.data import ErrorMessages
...
class TestCreateOrder:
    ...
    def test_create_order_with_auth_and_valid_ingredients(self, order_api, existing_user, valid_ingredient_id):
        ...
        assert jsonschema.validate(instance=data, schema=CREATE_ORDER_SUCCESS_SCHEMA) is None
    ...
    def test_create_order_without_ingredients(self, order_api, existing_user):
        ...
        assert data["message"] == ErrorMessages.INVALID_INGREDIENTS
...
class TestGetUserOrders:
    ...
    def test_get_user_orders_authorized(self, order_api, existing_user):
        ...
        assert response.status_code == 200
        assert jsonschema.validate(instance=data, schema=GET_ORDERS_SUCCESS_SCHEMA) is None
    ...
    def test_get_user_orders_unauthorized(self, order_api):
        ...
        assert jsonschema.validate(instance=data, schema=ERROR_SCHEMA) is None
        assert data.get("message") == ErrorMessages.NOT_AUTHORIZED
